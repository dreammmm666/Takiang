      ...
      <nav className="menu">
        <ul>
          <li style={{ marginLeft: '5rem' }}>
            <a href="/MarketingWorkTable_U">ตารางงานการตลาด</a> </li>

             <li>
   <a href="/MarketingWorkTable_U">ส่งงาน</a></li>
           
          <p className='role'>ตําเเหน่ง: {roleName[role] || `ไม่ทราบสิทธิ์ (${role})`}</p> {/* DEBUG แสดงค่าจริง */}
...
export default Navbar_marketing;
